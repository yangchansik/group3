...
System.out.println("tcode" + request.getParameter("tcode"));
System.out.println("bcode" + request.getParameter("tcode"));
%>
<!DOCTYPE html>
<html>
                     ...
                     <table class="table">
                        <tr>
                          ...
                          <tr>
                           ...
                           <td><input type="text" class="form-control" name="id" id="id" readonly value="${sessionScope.userid}">${sessionScope.userid}</td>
                        </tr>
